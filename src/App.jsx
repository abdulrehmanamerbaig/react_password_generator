    ...
    <>
      <div className='container'>
        ...
        <div className="clipboard">
          ...
          <div className="svg_decor position-relative mt-3 pb-5">
              <svg className='copy_button' onClick={copyPasswordToClipboard} xmlns="http://www.w3.org/2000/svg" style={{ minWidth: '250px', maxWidth: '300px' }} width="30%" height="58" viewBox="0 0 10% 64" fill="none">
            ...
            <div className="s_-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="15%" height="24" viewBox="0 0 14% 24" fill="none">
      ...
      <div className="row mt-2 mb-1">
        <div className="col-lg-3 col-md-5 col-12 d-flex gap-2 align-items-center">
          <input 
        type="checkbox"
      ...
      <div className="row">
      <div className="col-md-5 col-lg-3 col-12 d-flex gap-2">
        <input 
      type="checkbox"
      value={numberAllowed}
